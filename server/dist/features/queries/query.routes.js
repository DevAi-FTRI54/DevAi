...
import { addMessageSchema, askQuestionSchema, } from './validators/query.validators.js';
const router = express.Router();
router.post('/question', requireAuth, validateBody(askQuestionSchema), askController);
