...
const envSchema = z.object({
    ...
    GITHUB_PAT: z
        .string()
        .optional()
        .describe('Optional GitHub personal access token used by local test scripts'),
...
export const { NODE_ENV, PORT, MONGODB_URI, QDRANT_URL, QDRANT_API_KEY, REDIS_URL, GITHUB_APP_ID, GITHUB_APP_SLUG, GITHUB_APP_CLIENT_ID, GITHUB_APP_CLIENT_SECRET, GITHUB_REDIRECT_URI, GITHUB_APP_PRIVATE_KEY, REDIRECT_AFTER_INSTALL, JWT_SECRET, OPENAI_API_KEY, COHERE_API_KEY, FRONTEND_BASE_URL, ALLOWED_ORIGINS, INTERNAL_TEAM_TOKEN, FINE_TUNING_TOKEN, GITHUB_PAT, GITHUB_ACCESS_TOKEN, } = env;
/**
